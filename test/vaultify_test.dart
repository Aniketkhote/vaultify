...
void main() async {
  ...
  test('newContainer', () async {
    final container1 = await Vaultify.init('container1');
    await Vaultify.init('newContainer');
    final newContainer = Vaultify('newContainer');

    /// Attempting to start a Container that has already started must return the container already created.
    var container2 = await Vaultify.init();
